...
function MainNavLink({
  ...
  return (
    <NavLink to={to} end={end} className={({ isActive }) => navLinkClass(isActiveWhen ? isActiveWhen(pathname) : isActive)}>
      {children}
    </NavLink>
  );
}
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-8">
            <Link to="/" className="flex items-center gap-3">
              ...
              />
              <div>
                <div className="text-2xl font-bold" style={{ color: '#0EA5E9' }}>HAMEL</div>
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <MainNavLink to="/products" isActiveWhen={(p) => p === '/products' || p.startsWith('/product/')}>
                Products
              </MainNavLink>
              <MainNavLink to="/brands">Brands</MainNavLink>
              <MainNavLink to="/cool-deals">Cool Deals</MainNavLink>
